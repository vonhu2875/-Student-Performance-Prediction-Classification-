...
| --- | --- |
| **Võ Thị Bích Như** | - Thiết kế sơ đồ Database (ERD) đồng bộ với các thuộc tính dữ liệu sau khi EDA.<br>- Xây dựng cấu trúc API Backend để tiếp nhận dữ liệu đầu vào.<br>- Viết báo cáo tuần 2 và quản lý tiến độ chung của nhóm. |
